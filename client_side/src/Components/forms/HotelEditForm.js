    ...
    return(
        <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              { location && location.length && <AlgoliaPlaces className="form-control m-2 " placeholder="location"
          ...
          <div className="row">
                <div className="col-md-6">
                    {from &&  (<DatePicker defaultValue={moment(from,"YYYY-MM-DD")}
                                placeholder="From Date" className="form-control m-2"
                 ...
                 <div className="col-md-6">
                     {to && (<DatePicker defaultValue={moment(to,"YYYY-MM-DD")}
                                placeholder="To Date" className="form-control m-2"
